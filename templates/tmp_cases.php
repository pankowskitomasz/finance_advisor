...
<section class="user-s1 bg-light-green grid-x grid-padding-x align-center align-bottom minh-340px">
    <div class="cell small-10 medium-6 text-center text-shadow padding-1">
        <h2 class="h3 text-white font-bold">Cases list</h2>   
    </div>
</section>
                            ...
                            <table class="table hover">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Title</th>
                                        <th class="hide-for-small-only">Category</th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                        ...
                                        for($i=$pstart;$i<count($tab) && $i<$pend;$i++){
                                            echo "<tr>".
                                                ...
                                                "<td class='pl-0 pr-1'>".
                                                "<button type='submit' name='msgdelete' class='button small secondary hollow float-right' value='".$tab[$i][0]."'>X</button>".
                                                "<button type='submit' name='caseinfo' class='button small secondary hollow float-right' value='".$tab[$i][0]."'>i</button>".  
                                                "<button type='submit' name='editcase' class='button small secondary hollow float-right' value='".$tab[$i][0]."'>Edit</button>".                                           
                                                "</td></tr>";
                                        }
                                    ?>    
                                </tbody>
